...
TARGET_SECRET_REFLECTOR_NAMESPACES = os.environ.get('TARGET_SECRET_REFLECTOR_NAMESPACES', "")
...
def create_secret(json_data):
    ...
    annotations = {
            ...
            'reflector.v1.k8s.emberstack.com/reflection-allowed-namespaces': TARGET_SECRET_REFLECTOR_NAMESPACES,
            'reflector.v1.k8s.emberstack.com/reflection-auto-enabled': "true",
            'reflector.v1.k8s.emberstack.com/reflection-auto-namespaces': TARGET_SECRET_REFLECTOR_NAMESPACES
        }
